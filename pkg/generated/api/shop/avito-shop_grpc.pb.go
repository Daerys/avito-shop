...
const (
	AvitoShop_GetInfo_FullMethodName  = "/avito.shop.v1.AvitoShop/GetInfo"
	AvitoShop_SendCoin_FullMethodName = "/avito.shop.v1.AvitoShop/SendCoin"
	AvitoShop_BuyItem_FullMethodName  = "/avito.shop.v1.AvitoShop/BuyItem"
	AvitoShop_Auth_FullMethodName     = "/avito.shop.v1.AvitoShop/Auth"
)
...
func (c *avitoShopClient) Auth(ctx context.Context, in *AuthRequest, opts ...grpc.CallOption) (*AuthResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AuthResponse)
	err := c.cc.Invoke(ctx, AvitoShop_Auth_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedAvitoShopServer) Auth(context.Context, *AuthRequest) (*AuthResponse, error) {
...
func _AvitoShop_Auth_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AuthRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AvitoShopServer).Auth(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AvitoShop_Auth_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AvitoShopServer).Auth(ctx, req.(*AuthRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AvitoShop_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "avito.shop.v1.AvitoShop",
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Auth",
			Handler:    _AvitoShop_Auth_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "api/shop/avito-shop.proto",
}
